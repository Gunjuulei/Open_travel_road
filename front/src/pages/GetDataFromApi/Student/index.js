...
export const getHomeworksFetch = async ({ lesson, setHomework }) => {
    const responseHomework = await fetch(
        `http://localhost:3000/api/student/homework/get?lesson=${lesson}`,
        {
            method: 'GET',
            headers: {
...
export const getTopicFetch = async ({ _id , setTopic}) => {
    const responseTopic = await fetch(
        `http://localhost:3000/api/student/topic/single/get?_id=${_id}`,
        {
            method: 'GET',
            headers: {
                Authorization: `bearer ${Cookies.get('token')}`,
...
export const getScoreFetch = async ({ lesson, setScore }) => {
    const responseScore = await fetch(
        `http://localhost:3000/api/student/score/get?lesson=${lesson}`,
        {
            method: 'GET',
            headers: {
                Authorization: `bearer ${Cookies.get('token')}`,
...
export const getAttendanceFetch = async ({
    ...
    const responseScore = await fetch(
        `http://localhost:3000/api/student/attendance/get?lesson=${lessonId}`,
        {
            method: 'GET',
            headers: {
                Authorization: `bearer ${Cookies.get('token')}`,
    ...
    if (dataAttendance.success === true) {
        const isAttendance = dataAttendance.announcements || [];
...
export const getAnnouncementFetch = async ({ setAnnouncement }) => {
    const responseAnnouncement = await fetch(
        'http://localhost:3000/api/student/announcement/get?pageSize=20&pageNum=0',
        {
            method: 'GET',
            headers: {
                Authorization: `bearer ${Cookies.get('token')}`,
...
export const getClassStudentFetch = async ({ level, group, setStudentClasses }) => {
    const responseClass = await fetch(
        'http://localhost:3000/api/student/class/single/get/students?pageSize=20&pageNum=0',
        {
            method: 'GET',
            headers: {
                Authorization: `bearer ${Cookies.get('token')}`,
...
export const getClassTeacherFetch = async ({ level, group, setTeacherClasses }) => {
    const responseClass = await fetch(
        'http://localhost:3000/api/student/class/single/get/teachers?pageSize=20&pageNum=0',
        {
            method: 'GET',
            headers: {
                Authorization: `bearer ${Cookies.get('token')}`,
