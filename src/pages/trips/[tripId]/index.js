  ...
  return (
    <div className={"w-full"}>
      ...
      <div className={`flex w-full max-w-[100vw] relative flex z-0 flex-col`}>
        <section
          className={
            "w-full py-[80px] gap-24 flex flex-col lg:flex-row items-center lg:items-start lg:justify-center text-black relative z-1"
          }
        >
          <div className={"max-w-[520px] flex flex-col gap-4 items-start"}>
            <h2 className={"font-semibold text-5xl"}>{tripItem?.name}</h2>
            <p className={"text-[#6F6F6F] text-base"}>{tripItem?.desc}</p>
            <p className={"text-[#273A50] text-base"}>{tripItem?.desc2}</p>
            ...
            <div className={"flex flex-col gap-6 mt-10 text-black"} style={{ fontWeight: 500 }}>
              <p>{t("specialArr.title")}:</p>
              <ul className={"font-normal text-[14px] px-2"}>
                <li>- {t("specialArr.arr1")}</li>
                <li>- {t("specialArr.arr2")}</li>
                <li>- {t("specialArr.arr3")}</li>
              </ul>

              <p>{t("priceTrip.title")}:</p>
              <ul className={"font-normal text-[14px] px-2"}>
                <li>- {t("priceTrip.item1")};</li>
                <li>- {t("priceTrip.item2")};</li>
                <li>- {t("priceTrip.item3")};</li>
                <li>- {t("priceTrip.item4")};</li>
                <li>- {t("priceTrip.item5")};</li>
                <li>- {t("priceTrip.item6")};</li>
                <li>- {t("priceTrip.item7")};</li>
                <li>- {t("priceTrip.item8")};</li>
              </ul>

              <p>{t("priceTrip2.title")}:</p>
              <ul className={"font-normal text-[14px] px-2"}>
                <li>- {t("priceTrip2.item1")};</li>
                <li>- {t("priceTrip2.item2")};</li>
                <li>- {t("priceTrip2.item3")};</li>
                <li>- {t("priceTrip2.item4")};</li>
              </ul>
            </div>
          </div>
          <div className={"max-w-[560px] flex flex-col gap-4 items-start"}>
            ...
            <div className={"w-full flex flex-col gap-4 mt-8"}>
              {tripItem?.images.map((img, idx) => {
                return <Image key={idx} className={"w-full object-cover"} src={img} alt={""} />;
              })}
            </div>
          </div>
        </section>
      ...
      <div
        className={
          "mt-[200px] max-w-[1200px] mx-6 lg:mx-auto flex flex-col gap-10 my-[150px] justify-between"
        }
      >
        <h3 className={"font-bold text-5xl text-[#FF9F47]"}>{t("trips")}</h3>
